  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a0f', color: '#e2e8f0', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'system-ui' }}>
      <div style={{ textAlign: 'center', maxWidth: 560, padding: '40px 24px' }}>
        ...
        <h1 style={{ fontSize: 32, fontWeight: 800, margin: '0 0 16px', color: '#fff' }}>Javari Analytics</h1>
        <p style={{ fontSize: 16, color: '#9ca3af', lineHeight: 1.65, margin: '0 0 32px' }}>Platform analytics — usage, revenue, user behavior, and growth metrics.</p>
