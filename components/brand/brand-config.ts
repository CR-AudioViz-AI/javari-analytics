...
export const CREDITS_CONFIG = {
  ...
  plans: {
    ...
    // 2026-08-21: enterprise was missing entirely. It is a real tier in the User
    // contract, so CREDITS_CONFIG.plans[plan] returned undefined for those
    // accounts and the credits bar rendered blank for the highest-paying
    // customers. Type checking is disabled in this repo, so nothing said so -
    // turning it on is what surfaced it.
