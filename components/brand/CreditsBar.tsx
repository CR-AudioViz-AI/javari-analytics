...
interface CreditsBarProps {
  ...
  // (lib/central-services), so an enterprise customer rendered as free - the most
  // expensive plan displaying as the cheapest.
...
export function CreditsBar({ isLoggedIn, credits = 0, plan = 'free', userName }: CreditsBarProps) {
  ...
  // Enterprise is the top tier - there is nothing above it to upgrade to.
